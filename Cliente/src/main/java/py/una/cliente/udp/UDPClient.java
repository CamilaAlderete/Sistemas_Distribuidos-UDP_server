    ...
    public static void main(String a[]) throws Exception {
    	...
    	//PASO DE JSON A OBJETO
         ...
         while(true) {
        	 ...
        	 try {
	        	 id_hospital= Integer.parseInt(inFromUser.readLine());
	         }catch(Exception e) {
         ...
         while(true) {
        	 ...
        	 try {
        		 ...
        		 System.out.println("\nInput no valido...\n\n");
        		 continue; //no ejecuta las lineas de abajo...
        	 }
	         ...
	         //preparando paquete a ser enviado al servidor...
	         switch (operacion) {
	             case 1:
	        ...
	        String rta = new String();
	     	...
	     	try {
		     	...
		     	if(rta.equals("paquete_perdido")) {
		     		...
		     		//pasar respuesta a objeto....
		     		Cama presp = CamaJSON.stringObjeto(respuesta.trim());
		     		
		     		//en caso de que se reciban detalles de camas...
